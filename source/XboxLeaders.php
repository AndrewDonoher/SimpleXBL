			...
			'gamertag' => array(
				...
				'data' => array(
					'function' => create_function('$rowData', '
						$gamertag = \'<a href="http://live.xbox.com/member/\' . urlencode($rowData[\'gamertag\']) . \'">\' . $rowData[\'gamertag\'] . \'</a>\';
						return $gamertag;
					'),
					'style' => 'text-align: center',
				),
				...
				'data' => array(
					'sprintf' => array(
						'format' => '<a target="_blank" href="%1$s" onmouseover="xbl_show_gamer(\'gamercard\',\'%2$s\');" onmouseout="xbl_hide();">
							...
							<a target="_blank" href="http://avatar.xboxlive.com/avatar/%2$s/avatarpic-s.png" onmouseover="xbl_show_gamer(\'nxeavatar\',\'%2$s\');" onmouseout="xbl_hide();">
									<img height="32" width="32" src="http://avatar.xboxlive.com/avatar/%2$s/avatarpic-s.png" alt="" />
							</a>',
						'params' => array(
							'avatar' => false,
							'gamertag' => false,
